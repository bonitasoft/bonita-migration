...
ALTER TABLE "connector_instance" ADD "containerType_temp" VARCHAR2(10 CHAR) NOT NULL @@
...
ALTER TABLE "connector_instance" ADD "connectorId_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "connector_instance" ADD "version_temp" VARCHAR2(10 CHAR) NOT NULL @@
...
ALTER TABLE "connector_instance" ADD "name_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "arch_connector_instance" ADD "containerType_temp" VARCHAR2(10 CHAR) NOT NULL @@
...
ALTER TABLE "arch_connector_instance" ADD "connectorId_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "arch_connector_instance" ADD "version_temp" VARCHAR2(10 CHAR) NOT NULL @@
...
ALTER TABLE "arch_connector_instance" ADD "name_temp" VARCHAR2(255 CHAR) NOT NULL @@
