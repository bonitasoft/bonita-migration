...
ALTER TABLE "business_app" ADD "token_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "business_app" ADD "version_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "business_app" ADD "state_temp" VARCHAR2(30 CHAR) NOT NULL @@
...
ALTER TABLE "business_app" ADD "displayName_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "business_app_page" ADD "token_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "business_app_page" ADD "displayName_temp" VARCHAR2(255 CHAR) NOT NULL @@
UPDATE "business_app_page" SET "displayName_temp" = "displayName" @@
ALTER TABLE "business_app_page" DROP COLUMN "displayName" @@
ALTER TABLE "business_app_page" RENAME COLUMN "displayName_temp" TO "displayName" @@