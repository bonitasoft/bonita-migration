...
ALTER TABLE "ref_biz_data_inst" ADD "kind_temp" VARCHAR2(15 CHAR) NOT NULL @@
...
ALTER TABLE "ref_biz_data_inst" ADD "name_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "ref_biz_data_inst" ADD "data_classname_temp" VARCHAR2(255 CHAR) NOT NULL @@
