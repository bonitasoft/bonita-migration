...
ALTER TABLE "job_desc" ADD "jobclassname_temp" VARCHAR2(100 CHAR) NOT NULL @@
...
ALTER TABLE "job_desc" ADD "jobname_temp" VARCHAR2(100 CHAR) NOT NULL @@
...
ALTER TABLE "job_param" ADD "key__temp" VARCHAR2(50 CHAR) NOT NULL @@
