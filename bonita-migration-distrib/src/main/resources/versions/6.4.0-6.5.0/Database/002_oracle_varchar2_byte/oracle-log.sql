...
ALTER TABLE "queriable_log" ADD "userId_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "queriable_log" ADD "productVersion_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "queriable_log" ADD "severity_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "queriable_log" ADD "actionType_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "queriable_log" ADD "rawMessage_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "queriablelog_p" ADD "name_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "queriable_log" RENAME COLUMN "valueType_temp" TO "valueType" @@
