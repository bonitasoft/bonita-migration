...
ALTER TABLE "arch_transition_instance" ADD "name_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "arch_transition_instance" ADD "stateCategory_temp" VARCHAR2(50 CHAR) NOT NULL @@
