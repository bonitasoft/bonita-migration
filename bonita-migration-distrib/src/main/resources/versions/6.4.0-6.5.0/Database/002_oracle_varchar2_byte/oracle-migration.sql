...
ALTER TABLE "migration_plan" ADD "description_temp" VARCHAR2(255 CHAR) NOT NULL @@
...
ALTER TABLE "migration_plan" ADD "source_name_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "migration_plan" ADD "source_version_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "migration_plan" ADD "target_name_temp" VARCHAR2(50 CHAR) NOT NULL @@
...
ALTER TABLE "migration_plan" ADD "target_version_temp" VARCHAR2(50 CHAR) NOT NULL @@
