...
class Version_6_0_2_to_6_1_0Test {
    ...
    //        def version = new Version_6_0_2_to_6_1_0();
    //
    //        assertEquals(new FlowNodeDefinition(id:"-5109139435573341779",name:"gate2",type:"PARALLEL"),version.getTargetOfTransition(process, new TransitionInstance(id:"1",name:"step2_->_gate2")));
    //        assertEquals(new FlowNodeDefinition(id:"-8387720319258068830",name:"step1",type:"flownode"),version.getTargetOfTransition(process, new TransitionInstance(id:"2",name:"gate1_->_step1")));
    //        assertEquals(new FlowNodeDefinition(id:"-8558673934546753353",name:"end",type:"flownode"),version.getTargetOfTransition(process, new TransitionInstance(id:"3",name:"gate2_->_end")));
    //    }
}
