...
public class DatabaseChecker6_5_0 extends SimpleDatabaseChecker6_5_0 {
    ...
    /*
     * start - move all code bolow to a 7.0.0 checker step when 6.5.0 will be available
     */
    ...
    /*
     * end - move all code above to a 7.0.0 checker step when 6.5.0 will be available
     */
