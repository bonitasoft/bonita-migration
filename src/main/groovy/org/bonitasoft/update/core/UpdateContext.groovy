...
import static org.bonitasoft.update.core.database.DbConfig.*
...
class UpdateContext {
     ...
     * @return the properties of the update tool distribution
     */
    void loadConfiguration() {
        ...
        dbVendor = UpdateStep.DBVendor.valueOf(getSystemPropertyOrFromConfigFile(DB_VENDOR, properties, true).toUpperCase())
    ...
    private void completeLoggingConfiguration(Properties properties) {
        ...
        loggingConfiguration.configureUpdateLogger(level)
    }
