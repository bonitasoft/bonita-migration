...
class ConfigurationHelper {
    ...
    ConfigurationHelperNoTenant noTenant = new ConfigurationHelperNoTenant()

    /**
     * Specific version of the helper class to manage configuration files without tenant_id (for versions >= 10.3.0)
     */
    class ConfigurationHelperNoTenant {

        /**
         * Update configuration file content without tenant_id (for versions >= 10.3.0)
         */
        def updateConfigurationFileContent(String fileName, String type, byte[] content) {
