 ...
 */
class FixProcessPermissionRuleScript extends MigrationStep {

    public static String resourceName = "ProcessPermissionRule.groovy"
    ...
    def getNewContent() {
        def newScriptContent = this.getClass().getResourceAsStream("/version/to_7_3_1/${resourceName}.txt").bytes
        newScriptContent
    }
    ...
    String getDescription() {
        return "update ProcessPermissionRule.groovy security script"
    }
}
