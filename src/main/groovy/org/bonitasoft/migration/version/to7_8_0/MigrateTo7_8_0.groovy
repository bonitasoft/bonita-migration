...
""")
    ...
    String[] getPreMigrationWarnings() {
        ...
        ["Bonita 7.8 does not support 6.x Legacy forms and overview pages based on Google Web Toolkit (GWT) technology anymore.",
         "For processes with v6 forms to be migrated, they must be disabled and have only archived cases.",
         ...
         "To know more, check the (documentation) (link: https://documentation.bonitasoft.com/bonita/7.8/migrate-a-form-from-6-x).",
         "The latest Bonita version to support 6.x forms and overview pages is Bonita 7.7.4. It will be supported until June 2020.",
