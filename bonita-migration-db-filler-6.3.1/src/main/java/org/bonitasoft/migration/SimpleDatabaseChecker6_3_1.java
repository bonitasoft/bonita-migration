...
public class SimpleDatabaseChecker6_3_1 extends DatabaseCheckerInitiliazer6_3_1 {
    ...
    public void can_complete_the_execution_of_previous_started_process_and_start_a_new_one() throws Exception {
        ...
        final long processDefinitionId = processAPI.getProcessDefinitionId(SimpleDatabaseFiller6_0_2.PROCESS_NAME, SimpleDatabaseFiller6_0_2.PROCESS_VERSION);
        ...
        final SearchResult<ProcessInstance> searchResult = processAPI.searchProcessInstances(builder.done());
        ...
        for (final ProcessInstance processInstance : searchResult.getResult()) {
            final HumanTaskInstance taskInstance = waitForUserTask(SimpleDatabaseFiller6_0_2.USER_TASK_NAME, processInstance.getId(), APITestUtil.DEFAULT_TIMEOUT);
