...
class DbParserTest extends Specification {
    ...
    def "should parse #dbUrl"() {
        ...
        'jdbc:oracle:thin:@//localhost:1521/FREEPDB1.localdomain?oracle.net.disableOob=true'   | new DbParser.DbConnectionSettings(dbUrl:'jdbc:oracle:thin:@//localhost:1521/FREEPDB1.localdomain?oracle.net.disableOob=true', serverName: 'localhost', portNumber: '1521', databaseName: 'FREEPDB1.localdomain', genericUrl: 'jdbc:oracle:thin:@//localhost:1521/FREEPDB1.localdomain?oracle.net.disableOob=true')
